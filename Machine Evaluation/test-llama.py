...
# --- Fungsi bantu untuk membersihkan output ---
...
# --- Load model hasil fine-tuning LLaMA ---
...
FastLanguageModel.for_inference(model)  # optimasi untuk inferensi
...
for conv_id in tqdm(conv_ids, desc="Running LLaMA inference"):
    conv_df = df[df["conv_id"] == conv_id].reset_index(drop=True)

    # Masukkan semua utterance asli dulu
    ...
    # Ambil utterance seeker terakhir
...
output_path = "results_llama_eval.csv"
